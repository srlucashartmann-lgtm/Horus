...
export default function ThemeWidth() {
  ...
  const handleContainerChange = (event: ChangeEvent<HTMLInputElement>) => {
    setField('container', event.target.value === 'container');
  };
        ...
        <FormControlLabel
          ...
          label={
            <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
              ...
              <Typography variant="caption">Fluido</Typography>
            </Stack>
          }
        />
        <Tooltip
          title={downXL && 'O layout contêiner não é necessário para notebooks ou tablets.'}
          placement="top-start"
          arrow
          slotProps={{
          ...
          <FormControlLabel
            ...
            label={
              <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
                ...
                <Typography variant="caption">Contêiner</Typography>
              </Stack>
            }
          />
        </Tooltip>
