...
export default function Customization() {
  ...
  const message1 = colorScheme === ThemeMode.DARK ? message1Dark : message1Light;
  const message2 = colorScheme === ThemeMode.DARK ? message2Dark : message2Light;
  const message3 = colorScheme === ThemeMode.DARK ? message3Dark : message3Light;
  const message4 = colorScheme === ThemeMode.DARK ? message4Dark : message4Light;
  ...
  return (
    <>
      ...
      <Drawer
        ...
        open={open}
        slotProps={{ paper: { sx: { width: { xs: 350, sm: 474 } } } }}
      >
        {open && (
