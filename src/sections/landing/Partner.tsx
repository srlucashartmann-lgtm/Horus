...
export default function PartnerPage() {
  ...
  const items = [
    { image: colorScheme === ThemeMode.DARK ? client1Dark : client1Light, alt: 'EA Games logo' },
    { image: colorScheme === ThemeMode.DARK ? client2Dark : client2Light, alt: 'Vodafone logo' },
    { image: colorScheme === ThemeMode.DARK ? client3Dark : client3Light, alt: 'Crystal logo' },
    { image: colorScheme === ThemeMode.DARK ? client4Dark : client4Light, alt: 'Haswent logo' },
    { image: colorScheme === ThemeMode.DARK ? client5Dark : client5Light, alt: 'Haxter logo' },
    { image: colorScheme === ThemeMode.DARK ? client6Dark : client6Light, alt: 'Montecito logo' },
    { image: colorScheme === ThemeMode.DARK ? client7Dark : client7Light, alt: 'Slingshot logo' },
    { image: colorScheme === ThemeMode.DARK ? client8Dark : client8Light, alt: 'Total Studio logo' }
  ];
            ...
            {items.map((item, index) => (
              <Grid key={index}>
                <FadeInWhenVisible>
                  ...
                  >
                    <CardMedia component="img" image={item.image} sx={{ width: 'auto' }} alt={item.alt} />
                  </Box>
                </FadeInWhenVisible>
              </Grid>
            ))}
