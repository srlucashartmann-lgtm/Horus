...
>
  <TimelineItem>
    <TimelineOppositeContent sx={{ color: 'text.secondary', textAlign: 'right' }}>
  ...
  <TimelineItem>
    <TimelineOppositeContent sx={{ textAlign: 'right', color: 'text.secondary' }}>
      <Typography variant="body2">11:30 am</Typography>
    </TimelineOppositeContent>
    <TimelineSeparator>
  ...
  <TimelineItem>
    <TimelineOppositeContent sx={{ textAlign: 'right', color: 'text.secondary' }}>
      <Typography variant="body2">12:30 am</Typography>
    </TimelineOppositeContent>
    <TimelineSeparator>
