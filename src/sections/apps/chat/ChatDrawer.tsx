...
export default function ChatDrawer({ handleDrawerOpen, openChatDrawer, setUser, selectedUser }: ChatDrawerProps) {
  ...
  return (
    ...
    >
      <MainCard
        sx={{ borderRadius: '12px 0 0 12px', borderRight: 'none', display: 'flex', flexDirection: 'column' }}
        border={!downLG}
        content={false}
      >
        <Box sx={{ p: 3, pb: 1 }}>
          ...
          <Grid container>
            <Grid size={12}>
              <Grid container spacing={1} sx={{ alignItems: 'center', flexWrap: 'nowrap' }}>
                ...
                <Grid size="grow">
                  <Stack sx={{ cursor: 'pointer', textDecoration: 'none' }} component={NextLink} href="/apps/profiles/user/personal">
