...
export default function LatestPosts() {
  return (
    <MainCard
      ...
      content={false}
      secondary={
        <Links component={NextLink} href="#" color="primary">
          View all
        </Links>
      }
    >
        ...
        <Grid container spacing={3}>
          <Grid size={12}>
            <Grid container spacing={2} sx={{ alignItems: 'center' }}>
              <Grid>
                <CardMedia component="img" alt="dashboard 1" image={Dashboard1} title="image" sx={mediaSX} />
              </Grid>
              <Grid size="grow">
          ...
          <Grid size={12}>
            <Grid container spacing={2} sx={{ alignItems: 'center' }}>
              <Grid>
                <CardMedia component="img" alt="dashboard 2" image={Dashboard2} title="image" sx={mediaSX} />
              </Grid>
              <Grid size="grow">
                <Grid container spacing={1}>
                  <Grid size={12}>
