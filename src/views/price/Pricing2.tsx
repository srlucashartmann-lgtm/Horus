    ...
    <Grid container spacing={GRID_COMMON_SPACING}>
      <Grid size={12}>
        <Alert
          ...
          sx={(theme) => ({ '&.MuiAlert-colorWarning': { backgroundColor: withAlpha(theme.vars.palette.warning.lighter, 0.15) } })}
        >
                      ...
                      <FormControlLabel
                        ...
                        label={
                          <Stack direction="row" sx={{ gap: 0.5, alignItems: 'center', justifyContent: 'space-between', width: 1 }}>
                            ...
                            <Stack direction={{ sm: 'row', xs: 'column' }} sx={{ alignItems: 'flex-end' }}>
