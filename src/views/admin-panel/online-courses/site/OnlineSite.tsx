...
function TabActions({ activeStep, onAddBio }: TabActionsProps) {
  switch (activeStep) {
    case 0:
      return (
      ...
      <MainCard
        ...
        secondary={
          <Stack direction="row" sx={{ gap: 1 }}>
            <TabActions activeStep={activeStep} onAddBio={() => setOpenAddBioModal(true)} />
            {activeStep !== 0 && (
              <Button
                size="small"
                variant="contained"
            ...
            {steps.map((step, index) => (
              ...
              >
                <StepLabel
                  ...
                  slotProps={{ label: { sx: { typography: 'h6' } } }}
                >
                  {step.label}
                </StepLabel>
              </Step>
