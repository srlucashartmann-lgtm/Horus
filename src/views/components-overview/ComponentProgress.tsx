...
<CircularWithPath size={80} showLabel variant="determinate" value={55} color="secondary" />`;
  ...
  const llProgressCodeString = `<LinearWithIcon value={100} color="success" icon={<TickCircle variant="Bold" color={theme.vars.palette.success.main} />} />
<LinearWithLabel variant="determinate" value={progress} />
<LinearWithIcon value={5} color="error" icon={<CloseCircle variant="Bold" color={theme.vars.palette.error.main} />} />`;
