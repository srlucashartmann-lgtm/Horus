            ...
            <Stack sx={{ gap: GRID_COMMON_SPACING }}>
              ...
              <MainCard title="Vector" codeString={vectorAvatarCodeString}>
                <Grid container spacing={1}>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 1" src={`${avatarImage}/vector-1.png`} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 2" src={`${avatarImage}/vector-2.png`} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 3" src={`${avatarImage}/vector-3.png`} />
                    </Avatar>
                  </Grid>
                  <Grid>
                    <Avatar>
                      <CardMedia component="img" sx={{ height: 40 }} alt="Vector 4" src={`${avatarImage}/vector-4.png`} />
                    </Avatar>
                  </Grid>
                </Grid>
              </MainCard>
                  ...
                  <Box sx={{ width: 222 }}>
                    ...
                    >
                      <AvatarGroup
                        max={6}
                        sx={{ '& .MuiAvatarGroup-avatar': { bgcolor: 'primary.main', cursor: 'pointer' } }}
                        slotProps={{ surplus: { onClick: () => setOpen(!open) } }}
                      >
                        <Avatar alt="Remy Sharp" src={`${avatarImage}/avatar-1.png`} />
                        <Avatar alt="Travis Howard" src={`${avatarImage}/avatar-2.png`} />
                        <Avatar alt="Cindy Baker" src={`${avatarImage}/avatar-3.png`} />
