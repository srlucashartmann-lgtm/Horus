...
export default function ComponentSlider() {
  ...
  const iconsSliderCodeString = `<Stack direction="row" sx={{ gap: 2, mb: 1, alignItems:"center" }}>
  <VolumeMute style={{ color: volume <= 25 ? 'inherit' : theme.vars.palette.text.secondary }} />
  <Slider aria-label="Volume" value={volume} onChange={handleVolumeChange} />
  <VolumeHigh style={{ color: volume > 25 ? 'inherit' : theme.vars.palette.text.secondary }} />
</Stack>`;
