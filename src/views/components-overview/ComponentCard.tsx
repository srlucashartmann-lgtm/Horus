...
export default function ComponentCard() {
  ...
  const basicCardCodeString = `<MainCard border={false} shadow={theme.vars.customShadows.z1} sx={{ height: '100%' }}>
...
<MainCard title="Card Title" border={false} shadow={theme.vars.customShadows.z1} sx={{ height: '100%' }}>
  <Typography variant="h6">Card Subtitle</Typography>
  <Typography variant="caption" color="text.secondary">
    This is card description
  </Typography>
            ...
            <MainCard title="Basic" codeString={basicCardCodeString}>
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <MainCard border={false} sx={(theme: Theme) => ({ height: '100%', boxShadow: theme.vars.customShadows.z1 })}>
                    <Typography variant="h6">Card Subtitle</Typography>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  <MainCard
                    title="Card Title"
                    border={false}
                    sx={(theme: Theme) => ({ height: '100%', boxShadow: theme.vars.customShadows.z1 })}
                  >
                    <Typography variant="h6">Card Subtitle</Typography>
                    <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                      This is card description
