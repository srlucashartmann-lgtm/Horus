            ...
            <Stack sx={{ gap: GRID_COMMON_SPACING }}>
              ...
              <MainCard title="Fab " codeString={fabButtonCodeString}>
                <Grid container spacing={2} sx={{ alignItems: 'center' }}>
                  <Grid>
                    <Fab color="primary" aria-label="add" role="fab-primary">
                      <Add style={{ fontSize: '1.3rem' }} />
                    </Fab>
                  </Grid>
                  <Grid>
                    <Fab color="info" aria-label="edit" role="fab-info">
                      <Edit style={{ fontSize: '1.3rem' }} />
                    </Fab>
                  </Grid>
                  <Grid>
                    <Fab disabled aria-label="like" role="fab-disabled">
                      <MicrophoneSlash style={{ fontSize: '1.3rem' }} />
                    </Fab>
                  </Grid>
                  <Grid>
                    <Fab color="error" variant="extended" aria-label="extended" role="fab-extended">
                      Extended
                    </Fab>
                  </Grid>
                </Grid>
