                      ...
                      <Grid container spacing={1}>
                        <Grid size={12}>
                          <AuthSocButton onClick={handleNext}>
                            <CardMedia
                              component="img"
                              src={colorScheme === ThemeMode.DARK ? imgSmsLight : imgSms}
                              alt="Facebook"
                      ...
                      <Grid
                        ...
                        sx={(theme) => ({
                          ...
                          '& .MuiRadio-root.Mui-checked + .MuiFormLabel-root': {
                            boxShadow: `0 0 0 1px ${theme.vars.palette.primary.main}, 0px 8px 24px rgba(27, 46, 94, 0.12)`,
                        ...
                        >
                          <OtpInput
                            ...
                            inputStyle={{
                              ...
                              border: '1px solid',
                              borderColor:
                                colorScheme === ThemeMode.DARK ? theme.vars.palette.secondary[200] : theme.vars.palette.secondary.light,
                              borderRadius: 4
                            }}
        ...
        <Grid size={12}>
          <Stack direction="row" sx={{ justifyContent: 'center', alignItems: 'baseline', mb: { xs: -0.5, sm: 0.5 } }}>
            <Typography align="center">
              ...
              <Typography
                component={Link}
                href={'https://help.market.envato.com/hc/en-us/articles/41383541904281-Envato-Market-User-Terms'}
                target="_blank"
