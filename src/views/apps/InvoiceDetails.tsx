...
// material-ui
import { useColorScheme, useTheme, Palette } from '@mui/material/styles';
...
function PDFIconButton({ list, currentPalette }: { list: InvoiceList; currentPalette: Palette }) {
  return (
    <PDFDownloadLink
      document={<ExportPDFView list={list} currentPalette={currentPalette} />}
