...
import { Activity, SyntheticEvent, useId, useState } from 'react';
                ...
                <Stack sx={{ gap: 1 }}>
                  ...
                  <TextField
                    ...
                    slotProps={{
                      ...
                      formHelperText: { sx: { mr: 0, display: 'flex', justifyContent: 'flex-end' } }
                    }}
                  />
                </Stack>
              </Grid>
                    ...
                    <Autocomplete
                      ...
                      renderOption={({ key, ...props }, option) => (
                        <Stack key={key} component="li" direction="row" sx={{ gap: 1, alignItems: 'center' }} {...props}>
                          <Activity mode={option.code ? 'visible' : 'hidden'}>
                            <CardMedia
                              component="img"
                              loading="lazy"
                              className="flagImg"
